...
<table class="easyui-datagrid" id="technologyList" title="跳转链接" data-options="singleSelect:false,collapsible:true,
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'technologyId',width:20,align:'center'">编号</th>
            <th data-options="field:'technologyName',width:100,align:'center'">跳转链接</th>
        </tr>
    </thead>
</table>
...
function doSearch_technology(value,name){ //用户输入用户名,点击搜素,触发此函数  
	if(value == null || value == ''){
		...
		$("#technologyList").datagrid({
	        title:'跳转链接', singleSelect:false, collapsible:true, pagination:true, rownumbers:true, method:'get',
